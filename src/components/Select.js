...
export default function SelectAutoWidth({setTypePokemon, getPokemons}) {
  ...
  return (
    <div>
      <FormControl sx={{ m: 1, minWidth: 80, backgroundColor:'white',borderRadius: "7px",width:"180px"  }}>
        <InputLabel Width="200px"  id="demo-simple-select-autowidth-label">Tipo de Pokémon</InputLabel>
        <Select
          onClick={getPokemons}
